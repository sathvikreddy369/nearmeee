  ...
  return (
    <>
      <Navbar 
        ...
        expand="lg" 
        fixed="top"
        className={`navbar-elegant py-1 ${scrolled ? 'navbar-scrolled shadow' : ''}`}
        expanded={expanded}
        onToggle={handleToggle}
      >
        <Container fluid className="px-3">
          ...
          <Navbar.Collapse id="basic-navbar-nav" className="justify-content-between">
            {/* Center Navigation - Desktop */}
            <Nav className="mx-auto align-items-center d-none d-lg-flex">
              <Nav.Link 
                as={Link} 
                to="/" 
                className={`nav-link-elegant mx-2 ${isActiveRoute('/') ? 'active' : ''}`}
                onClick={closeMobileMenu}
              >
              ...
              <Nav.Link 
                as={Link} 
                to="/vendors" 
                className={`nav-link-elegant mx-2 ${isActiveRoute('/vendors') ? 'active' : ''}`}
                onClick={closeMobileMenu}
              >
              ...
              {userProfile?.role === 'vendor' && (
                <Nav.Link 
                  as={Link} 
                  to="/vendor-dashboard" 
                  className={`nav-link-elegant mx-2 ${isActiveRoute('/vendor-dashboard') ? 'active' : ''}`}
                  onClick={closeMobileMenu}
                >
              ...
              {userProfile ? (
                <>
                  ...
                  <Nav.Link 
                    as={Link} 
                    to="/messages" 
                    className="nav-link-elegant position-relative d-flex align-items-center justify-content-center me-2"
                    onClick={closeMobileMenu}
                  ...
                  >
                    ...
                    {userProfile.unreadMessages > 0 && (
                      ...
                      >
                        {userProfile.unreadMessages > 9 ? '9+' : userProfile.unreadMessages}
                      </Badge>
                    )}
                  </Nav.Link>

                  {/* Notification Bell - Fixed alignment */}
                  <div className="d-flex align-items-center justify-content-center me-2" style={{ width: '44px', height: '44px' }}>
                    <NotificationBell />
                  </div>
                  ...
                  >
                    <div className="px-3 py-2 border-bottom">
                      ...
                      <small className="text-muted">{userProfile.email}</small>
                      <div className="mt-2">
                        <Badge bg="primary" className="me-1" style={{ fontSize: '0.7rem' }}>
                          {userProfile.role}
                        </Badge>
                        {userProfile.isVerified && (
                    ...
                    <NavDropdown.Item 
                      onClick={() => { navigate('/dashboard'); closeMobileMenu(); }}
                      className="dropdown-item-elegant"
                    >
                    ...
                    {userProfile.role === 'vendor' && (
                      <NavDropdown.Item 
                        onClick={() => { navigate('/vendor-dashboard'); closeMobileMenu(); }}
                        className="dropdown-item-elegant"
                      >
                    ...
                    <NavDropdown.Item 
                      onClick={handleLogout}
                      className="dropdown-item-elegant text-danger"
                    >
                ...
                <div className="d-flex gap-2 align-items-center">
                  <Nav.Link 
                    as={Link} 
                    to="/register-vendor" 
                    className="nav-link-elegant text-primary fw-semibold px-3"
                    onClick={closeMobileMenu}
                  >
                    For Businesses
                  </Nav.Link>
          ...
          <div className="d-flex align-items-center d-lg-none">
            {userProfile && (
              <>
                <div 
                  className="d-flex align-items-center justify-content-center me-2 position-relative"
                ...
                >
                  <Button
                    ...
                    to="/messages"
                    variant="link"
                    className="p-0 d-flex align-items-center justify-content-center text-dark"
                    onClick={closeMobileMenu}
                ...
                {/* Notification Bell in mobile view - Fixed alignment */}
                <div 
            ...
            >
              <Button
                variant="link"
                className="navbar-toggler-custom p-0 border-0 d-flex align-items-center justify-content-center"
                onClick={handleToggle}
                aria-controls="basic-navbar-nav"
                aria-expanded={expanded}
                style={{ width: '100%', height: '100%' }}
      ...
      <Offcanvas 
        ...
        style={{ width: '300px' }}
      >
        <Offcanvas.Header className="border-bottom pb-3 bg-light">
          <div className="d-flex align-items-center w-100">
            {userProfile ? (
              <>
                <div 
              ...
              <div className="text-center w-100">
                <Logo size={35} className="mb-2 justify-content-center" />
                <h5 className="fw-bold text-dark mb-1">Nearమీ</h5>
                <p className="text-muted small">Discover local businesses</p>
              </div>
            )}
          </div>
          <Button 
            variant="link" 
            className="p-0 ms-2 d-flex align-items-center justify-content-center" 
            onClick={closeMobileMenu}
        ...
        <Offcanvas.Body className="p-0 d-flex flex-column">
          {/* Mobile Navigation Menu */}
          <Nav className="flex-column flex-grow-1">
            <div className="px-3 py-2 text-uppercase small fw-semibold text-muted bg-light">
              Navigation
            </div>
            ...
            {userProfile ? (
              <>
                {/* User Specific Links */}
                <div className="px-3 py-2 text-uppercase small fw-semibold text-muted mt-2 bg-light">
                  My Account
                </div>
                ...
                <Nav.Link 
                  ...
                  onClick={closeMobileMenu}
                >
                  <MessageCircle size={18} className="me-3" />
                  Messages
                  {userProfile.unreadMessages > 0 && (
          ...
          <div className="border-top p-3 mt-auto bg-light">
            <div className="text-center">
              <small className="text-muted">
                &copy; 2025 Nearమీ. All rights reserved.
              </small>
            </div>
          </div>
        </Offcanvas.Body>
