...
function VendorDetailPage() {
  ...
  const { currentUser, userProfile } = useAuth();
  const { addToast } = useToast();
  const { location: userLocation, getPosition } = useGeolocation();
  ...
  const handleShare = async () => {
    const shareUrl = window.location.href;
    const shareText = `Check out ${vendor.businessName} on Nearమీ!`;
  ...
  const getVerificationBadges = () => {
    ...
    if (vendor.verificationStatus === 'verified_basic') {
      badges.push(
        <Badge key="basic" className="verified-badge">
          <Shield size={12} />
          Verified by NearMe
        </Badge>
      );
    ...
    if (vendor.verificationStatus === 'verified_gst') {
      badges.push(
        <Badge key="gst" className="gst-verified-badge">
          <FileCheck size={12} />
    ...
    if (vendor.verificationStatus === 'verified_premium') {
      badges.push(
        <Badge key="premium" className="premium-badge">
          <Crown size={12} />
          Premium Partner
        </Badge>
      );
    ...
    badges.push(
      <Badge key="status" className="status-badge">
        {vendor.isOpen ? (
          <>
            <CheckCircle size={12} />
            Open Now
  ...
  if (error) {
    return (
      <Container className="my-5">
        <Alert variant="danger" className="border-0 shadow-soft text-center">
          <div className="py-4">
            <XCircle size={48} className="text-danger mb-3" />
            <h4 className="text-danger">Error Loading Vendor</h4>
            <p className="mb-4">{error}</p>
  ...
  if (!vendor) {
    return (
      <Container className="my-5">
        <Alert variant="info" className="border-0 shadow-soft text-center">
          <div className="py-4">
            <Users size={48} className="text-primary mb-3" />
            <h5>Vendor not found</h5>
            <p className="mb-3">The vendor you're looking for doesn't exist or has been removed.</p>
  ...
  const operatingHours = formatOperatingHours(vendor.operatingHours);
      ...
      <Container className="vendor-detail-page py-4">
        ...
        <div className="mb-4">
          <Button 
            ...
            as={Link} 
            to="/vendors"
            className="d-flex align-items-center border-soft"
          >
            <ArrowLeft size={18} className="me-2" />
            Back to Vendors
          </Button>
        ...
        <div className="vendor-header">
          <div className="vendor-header-content">
            ...
            <h1 className="text-white fw-bold mb-3 display-6">{vendor.businessName}</h1>
            ...
            <p className="text-white-50 lead mb-4">{vendor.description}</p>

            <div className="d-flex gap-2 flex-wrap">
              <Button 
                variant={isFavorited ? "warning" : "outline-light"} 
                onClick={handleFavoriteToggle}
                className="d-flex align-items-center"
              >
                <Heart size={18} fill={isFavorited ? "currentColor" : "none"} className="me-2" />
            ...
            {vendor.services && vendor.services.length > 0 && (
              <Card className="info-card">
                <Card.Header className="info-card-header">
                  <h4 className="fw-bold mb-0 d-flex align-items-center">
                    <Award size={24} className="me-2 text-primary" />
                    Services & Pricing
                  </h4>
                </Card.Header>
              ...
              <Card className="info-card">
                ...
                <Card.Body className="info-card-body">
                  <div className="timing-grid">
                    {operatingHours.map((timing, index) => (
                      <div key={index} className="timing-item">
                        <span className="timing-day">{timing.day}</span>
                        <span className={timing.isClosed ? "timing-closed" : "timing-hours"}>
            ...
            <Card className="info-card">
              ...
              <Card.Body className="info-card-body">
                ...
                {currentUser ? (
                  ...
                  <Alert variant="info" className="border-soft bg-light mb-4">
                    <div className="d-flex align-items-center">
                      <MessageCircle size={20} className="me-3 text-primary" />
                      <div>
                        <Link to="/auth" className="fw-semibold text-primary text-decoration-none">
                          Log in
                        </Link>{' '}
                        to share your experience with this business.
                      </div>
              ...
              <Card className="info-card mb-4">
                <Card.Body className="info-card-body">
                  ...
                  <ListGroup variant="flush" className="vendor-info-list">
                    <div className="contact-item">
                      ...
                      <div className="contact-content">
                        <div className="fw-semibold text-dark">{vendor.address?.street}</div>
                        <small className="text-muted">
                          {vendor.address?.city}, {vendor.address?.state} {vendor.address?.zipCode}
                        </small>
                      </div>
                    ...
                    {vendor.contactPhone && (
                      <div className="contact-item">
                        ...
                        <div className="contact-content">
                          <div className="fw-semibold text-dark">{vendor.contactPhone}</div>
                        </div>
                      </div>
                    )}
                    ...
                    {vendor.contactEmail && (
                      <div className="contact-item">
                        ...
                        <div className="contact-content">
                          <div className="fw-semibold text-dark">{vendor.contactEmail}</div>
                        </div>
                      </div>
                    )}
                    ...
                    {vendor.establishmentDate && (
                      <div className="contact-item">
                        <Calendar size={20} className="contact-icon" />
                        <div className="contact-content">
                          <div className="fw-semibold text-dark">Established</div>
                          <small className="text-muted">
                            {new Date(vendor.establishmentDate).toLocaleDateString()}
                          </small>
                        </div>
                      </div>
                    )}
                  ...
                  <div className="action-buttons mt-4">
                    ...
                    <Button
                      variant="outline-primary"
                      onClick={() => window.open(`https://www.google.com/maps/dir/?api=1&destination=${vendor.location.latitude},${vendor.location.longitude}`)}
                      className="btn-action"
                    >
